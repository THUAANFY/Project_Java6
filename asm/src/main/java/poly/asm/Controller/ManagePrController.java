        ...
        if (!imageFile.isEmpty()) {
            try {
                ...
                if (existingProduct.getImage() != null && !existingProduct.getImage().isEmpty()) {
                    String oldImagePath = "D:/project_Java6/Project_Java6/asm/src/main/resources/static" + existingProduct.getImage();
        ...
        try {
            ...
            if (productOpt.isPresent()) {
                ...
                if (product.getImage() != null) {
                    String imagePath = "D:/project_Java6/Project_Java6/asm/src/main/resources/static" + product.getImage();
