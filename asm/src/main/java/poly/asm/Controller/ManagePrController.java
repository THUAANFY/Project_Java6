...
public class ManagePrController {
    ...
    public String createProduct(@ModelAttribute Product item, 
        ...
        if (!imageFile.isEmpty()) {
            try {
                // Đường dẫn lưu ảnh
                String uploadDir = "D:\\ASSIGNMENT\\Project_Java6\\asm\\src\\main\\resources\\static\\Images\\";
        ...
        if (!imageFile.isEmpty()) {
            try {
                ...
                if (existingProduct.getImage() != null && !existingProduct.getImage().isEmpty()) {
                    String oldImagePath = "D:\\ASSIGNMENT\\Project_Java6\\asm\\src\\main\\resources\\static\\Images\\" + existingProduct.getImage();
        ...
        try {
            ...
            if (productOpt.isPresent()) {
                ...
                if (product.getImage() != null) {
                    String imagePath = "D:\\ASSIGNMENT\\Project_Java6\\asm\\src\\main\\resources\\static\\Images\\" + product.getImage();
