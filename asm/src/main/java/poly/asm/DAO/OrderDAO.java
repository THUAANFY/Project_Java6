...
public interface OrderDAO extends JpaRepository<Order, Integer>{
        ...
        List<Order> findByStatusAndCreatedAtBetween(String status, Date startDate, Date endDate);
        ...
        Page<Order> findByOrderCodeContainingOrRecipientNameContainingOrRecipientPhoneContaining(String orderCode, String name, String phone, Pageable pageable);
